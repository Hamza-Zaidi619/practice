...
// document.write("DATA TYPE OF MY DECLARED VARAIBLE IS  NUMBER" +"<br />" +"<br />" );

// // QUESTION NO 4
// var storeNAME="CHASE UP SHOPPING CENTER";
// var visitorNAME="MIRZA AHMER BAIG";
// var productTITLE="T SHIRT";
// var quantity=9;
// document.write(visitorNAME +"ORDERED "+ quantity + productTITLE +"ON"+ storeNAME + "." +"<br />" +"<br />"  );
...
// // QUESTION NO 3
// document.write("<h2> RULE FOR NAMING JS VARAIBLE </h2>");
// var num="numbers";
// var sign="$";
// var example="my_1stVariable";
// document.write("VARAIBLE NAMES CAN ONLY CONTAIN " + num + ", "+ sign +" AND _ . FOR EXAMPLE :"+ example +"<br />");
// var sense = "sensitve"
// document.write("Variables names are case" + " " + sense +"<br />");
// var key = "keywords"
// document.write("Variables names should not be JS" + " " + key +"<br />");
...
// var f=7;
// var d=e-f;
// document.write("SUBTRACTION OF " +e +" AND "+f +" IS "+ d +"<br />");

// // QUESTION NO 2(B)
// var g=77;
// var h=7;
// var i=g*h;
// document.write("SUBTRACTION OF " +g +" AND "+h +" IS "+ i +"<br />");

// // QUESTION NO 2(C)
// var j=50;
// var k=5;
// var l=j/k;
// document.write("SUBTRACTION OF " +j +" AND "+k +" IS "+ l +"<br />" +"<br />");

// // QUESTION NO 3
// var shooter;
// document.write("VALUE AFTER VARAIBLE DECLARATION IS : " + shooter +"<br />");
// shooter=5;
// document.write(" INTIAL VALUE IS : " + shooter +"<br />");
// ++shooter
// document.write(" VALUE AFTER INCREMENT IS : " + shooter +"<br />");
// shooter=shooter+7;
// document.write(" VALUE AFTER ADDITION IS : " + shooter +"<br />");
// --shooter;
// document.write(" VALUE AFTER DECREMENT IS : " + shooter +"<br />");
// shooter=shooter%shooter;
// document.write(" THE REMAINDER IS : " + shooter +"<br />");

// // QUESTION NO 4
// var price=600;
// var totalCost=price*5;
// document.write("<h2> TOTAL COST TO BUY 5 MOVIE TICKET IS " + totalCost + "PKR" + "</h2>");

// // QUESTION NO 5
// var tableNumber=+prompt("ENTER YOUR TABLE NUMBER",4);
// var now=1;
...
// ++now
// result=tableNumber*now
// // QUESTION NO 5 FINISHED
// // QUESTION NO 6
// document.write("<h2> THE TEMPERATURE CONVERTER "  + "</h2>");
// var celciusTemperature=+prompt("ENTER THE TEMPERATURE WHICH YOU WANT TO CONVERT\NCENTIGRADE INTO FARENHITE",25);
// var farenhiteTemperature=+prompt("ENTER THE TEMPERATURE WHICH YOU WANT TO CONVERT\NFARENHITE INTO CENTIGRADE",70);
// var conversion1= (farenhiteTemperature-32)*5/9;
// var conversion2= (celciusTemperature*9/5)+32;
// document.write(celciusTemperature+"C IS "+ conversion2+"F"+ "<br />")
// document.write(farenhiteTemperature+"F IS "+ conversion1+"C"+ "<br />");
// // QUESTION NO 6 FINISHED
// // QUESTION NO 7
// var priceOFitem1 =700;
// var priceOFitem2 =700;
// var orderedQuantityofItem1 =1;
// var orderedQuantityofItem2 =1;
// var shippingcharges=100;
// var totalshop=priceOFitem1+priceOFitem2+shippingcharges;
// document.write("<h2> THE SHOPPING CART "  + "</h2>");
// document.write("THE PRICE OF ITEM 1 IS  "  +  priceOFitem1 + "<br />");
// document.write("THE PRICE OF ITEM 2 IS  "  +  priceOFitem2 + "<br />");
// document.write("THE QUANTITY OF ITEM 1 IS"+ orderedQuantityofItem1  + "<br />");
...
// // QUESTION NO 2
// var gender = prompt("PLEASE ENTER YOUR GENDER MALE,FEMALE AND OTHER");
// if (gender === "male") {
//     alert("HELLO SIR");
// }
...
// // QUESTION NO 3
// var traffic = prompt("PLEASE ENTER THE TRAFFIC LIGHT COLOR");
// if (traffic === "red") {
//     alert("MUST STOP")
// }
...
// }
// else {
//     alert("PLEASE ENTER THE CORRECT COLOR OF LIGHT")
// }
// // QUESTION NO 4
// var fuel = +prompt("PLEASE ENTER THE REMAINING FUEL IN LITER")
// if (fuel <= 0.25) {
//     alert("PLEASE REFILL THE FUEL")
// }
// else {
//     alert("GO WHERE YOU WANT TO GO")
// }
// // QUESTION NO 5(A)
// var a1 = 4;
// if (++a1 === 5) {
...
// }
// else { alert("sorry condition is wrong") }
// // QUESTION NO 5(C)
// var c1 = 12; console.log(c1)
// if (c1++ === 13) {
...
// // QUESTION NO 6
// var subject1marks=+prompt("PLEASE ENTER THE MARKS OF 1 SUBJECT OUT OF 100");
// var subject2marks=+prompt("PLEASE ENTER THE MARKS OF 2 SUBJECT OUT OF 100");
// var subject3marks=+prompt("PLEASE ENTER THE MARKS OF 3 SUBJECT OUT OF 100");
// var obtainedMarks4=subject1marks+subject2marks+subject3marks;
// var totalmarks5=300;
// var percentage5=obtainedMarks4/totalmarks5*100;
//  document.write("<h2> MARK SHEET </H2>");
//  document.write("<h5> TOTAL MARKS : </H5>" + totalmarks5 );
//  document.write("<h5> OBTAINED MARKS : </H5>" + obtainedMarks4 );
//  document.write("<h5> PERCENTAGE : </H5>" + percentage5+"%" );
//  if(percentage5>=80){
//     document.write("<h5>  GRADE :  </H5> " + "A-0NE"  );
//     document.write("<h5>  REMARKS :  </H5> " + "EXCELLENT"+ "<br />"  );
//  }
// else if(percentage5>=70){
//     document.write("<h5>  GRADE :  </H5> " + "A"  );
//     document.write("<h5>  REMARKS :  </H5> " + "GOOD" + "<br />" );
// }
// else if(percentage5>=60){
//     document.write("<h5>  GRADE :  </H5> " + "B"  );
//     document.write("<h5>  REMARKS :  </H5> " + "YOU NEED TO IMPROVE" + "<br />" ); 
// }
// else{
//     document.write("<h5>  GRADE :  </H5> " + "FAIL"  );
//     document.write("<h5>  REMARKS :  </H5> " + "SORRY" + "<br />" + "<br />" ); 

// };

// // QUESTION NO 7
// var num_1=+prompt("PLEASE ENTER THE NUMBER OUT OF 10");
// var num_2=6;
// if(num_1===num_2){
...
// };
// // QUESTION NO 8
// var num_3=+prompt("ENTER THE NUMBER WHICH YOU WANT TO CHECK THE NUMBER IS / BY 3");
// var c4=num_3/3;
// if(num_3%3===0){
//     document.write(num_3 +    " THIS NUMBER IS DIVISIBLE BY 3" + "<br />" )
//     document.write("THE ANSWER IS "+ c4  + " <br />");
// }
// else{
//     document.write("SORRY THIS NUMBER IS NOT DIVISIBLE BY 3" + "<br />")
// };
// // QUESTION NO 9
// var even=+prompt("PLEASE ENTER THE NUMBER MAY BE EVEN OR ODD")
// if(even%2===0){
//     document.write("THE NUMBER IS : "+ even + "<br />")
//     document.write("THE NUMBER IS EVEN NUMBER: "+ "<br />")
// }
// else{
//     document.write("THE NUMBER IS : "+ even + "<br />")
//     document.write("THE NUMBER IS IS ODD NUMBER  " + " <br />")
// }
// // QUESTION NO 10
// var temp=+prompt("PLEASE ENTER THE TEMPERATURE");
// if(temp>=40){
//     document.write("  THE TEMPERATURE IS  " + temp +"\n IT IS TOO HOT OUTSIDE" + " <br />" );

// }
// if(temp>=30 && temp<20){
//     document.write("  THE TEMPERATURE IS  " + temp +"\n THE WHEATHER TODAY IS NORMAL" + " <br />" );

// }
// if(temp>=20 && temp<10){
//     document.write("  THE TEMPERATURE IS  " + temp +"\n TODAY WHEATHER IS COOL" + " <br />" );

// }
// if(temp>=10){
//     document.write(" THE TEMPERATURE IS  " + temp +"\n OMG THE WHEATHER IS COOL" + " <br />" );

// }
// else{
//     document.write("  THE TEMPERATURE IS  " + temp +"\n DANGEROUS  THE WHEATHER IS COOL" + " <br />" );

// };
// // QUESTION NO 11
// var firstNumber=+prompt("PLEASE ENTER THE FIRST NUMBER");
// var secondNumber=+prompt("PLEASE ENTER THE SECOND NUMBER");
// var opert=prompt("ENTER THE OPERATOR(+,/,*_)")
// var result7;
// if(opert==="+"){
//     result7=firstNumber+secondNumber
//     document.write(firstNumber + opert + secondNumber + "= " +result7 );
